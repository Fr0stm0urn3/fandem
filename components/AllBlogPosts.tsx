...
const AllBlogPosts = () => {
  ...
  return (
    ...
    // <section>
    //   <div>
    //     <div className="text-black flex justify-between py-4 lg:py-0 mb-[32px] lg:mb-[76px] px-[100px]">
    //       <ul className="flex text-[#898888] list-none gap-[46px] px-4">
    //         <li
    ...
    //             <div
    //               key={i}
    //               className="flex flex-col justify-between border border-[#888] rounded-[10px] max-w-[372px] "
    //             >
    //               {/* <Link href={`/blog/${i}`}>
    //               <Image
    //                 alt="Art"
    ...
    //           className={`${
    //             page === 1 ? "border-b border-b-[#1B1A1A]" : ""
    //-all           } hover:scale-110 transition cursor-pointer`}
    //         >
    //           1
    //         </span>
    //         <span
