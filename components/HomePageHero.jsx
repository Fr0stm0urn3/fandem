...
const HomePageHero = () => {
  ...
  return (
    // <header className="bg-[url('../public/assets/images/HeroBackgroundImage.png')] bg-right-top bg-no-repeat bg-fixed ">
    <div className="mt-[53px] mb-[243px] md:ml-[135px] md:mt-[171px] md:mb-[353px] flex flex-col mx-4 items-center justify-center md:justify-start md:items-start ">
      <h1 className="text-5xl md:text-6xl font-semibold leading-[57.6px] md:leading-[72px] shadow-md w-[340px] md:w-[570px]">
        Purpose-built NFT solutions for your{" "}
        <TextTransition springConfig={presets.wobbly} className="text-[#FFA800]">
          {`{${TEXTS[index % TEXTS.length]}}`}
        </TextTransition>
      </h1>
      <p className="w-[300px] -ml-8 md:ml-0 md:w-[470px] mt-5 mb-10 font-[gilroy] text-base leading-[27.2px] text-[#BEBEBE]">
      ...
      hover:bg-[#FFA800] hover:text-white  active:bg-[#D69516]  active:[#fff] w-[340px] md:w-fit"
      >
        Start Career
        <span>
          <svg
