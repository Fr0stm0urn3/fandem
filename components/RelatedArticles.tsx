...
const RelatedArticles = () => {
  ...
  return (
    <article className="container mx-auto mb-[100px] xl:mb-[150px]">
      <h2 className="text-[#1B1A1A] text-[40px] mb-8 lg:text-[50px] font-[500] lg:mb-[60px] text-center xl:text-start">
        Related Articles
      </h2>
      <div className="grid lg:grid-cols-2 xl:grid-cols-3 gap-[20px]  min-w-[343.195px] lg:min-w-[370px] ">
