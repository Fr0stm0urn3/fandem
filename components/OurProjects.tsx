...
const OurProjects = () => {
        ...
        <Slider {...settings} className="w-full" ref={slider}>
          {projects.length > 0 &&
            projects.map((project) => (
              <div
                className="flex flex-col justify-center items-center gap-[48px] lg:flex-row  lg:justify-between  mx-auto container 2xl:px-[135px] w-full"
              ...
              >
                <div className="flex flex-col items-center justify-center space-y-4 lg:flex-row lg:gap-6 z-10">
                  ...
                  <span className="lg:self-end flex z-10">
                    <button
                      className={`${
                        item === 1 ? "cursor-not-allowed" : "cursor-pointer"
                      } group`}
  ...
  //   <section
  //     id="projects"
  //     className="flex flex-col justify-center items-center mb-[168px] lg:mb-[243px]container mx-auto px-4 z-10 lg:px-[135px]"
  //   >
  //     <MiniTitle title={"Building The Future"} />
  //     <h2 className="text-[40px] lg:text-[50px] font-[500] leading-[65px] mb-10 lg:mb-20 z-10">
  //       Our Projects
  //     </h2>
  //     <Slider {...settings}>
  //       <div className="flex flex-col justify-center items-center gap-[48px] lg:flex-row  lg:justify-between  mx-auto container 2xl:px-[135px]">
  //         <div className="flex flex-col items-center justify-center space-y-4 lg:flex-row lg:gap-6 z-10">
  //           {projects.length > 0 ? (
  //             projects.map((project) => (
  //               <Link
  ...
  //     <div className="bg-white text-black text-2xl "></div>
  //   </section>
  // )
}
