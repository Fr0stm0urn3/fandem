...
const Footer = () => {
  ...
  return (
    <footer className="container mx-auto  text-[#949494] px-4 md:px-0  pt-[30px] lg:px-[135px]">
      <div className="flex flex-col lg:flex-row justify-between items-center mb-10  lg:mb-[28.93px] ">
        ...
        <Link href={"/"} className="ml-14 hidden lg:block">
          <Image
            alt="Logo"
            sizes="100vw"
            height={0}
      ...
      <div className="border border-[#434343] mx-4 lg:mx-0" />
      {/* <div className="flex justify-center gap-6 mt-[41px] lg:mt-[31px]">
        <span>
          <svg
            width="38"
            height="38"
            ...
            <defs>
              ...
              >
                ...
                <feBlend
                  ...
                  result="effect1_dropShadow_7_169"
                />
                <feBlend
                  mode="normal"
                  in="SourceGraphic"
                  in2="effect1_dropShadow_7_169"
                  result="shape"
                />
              </filter>
              <linearGradient
                id="paint0_linear_7_169"
                x1="-16.5764"
                y1="-62.2784"
                x2="-144.832"
                y2="-16.7583"
            ...
            <defs>
              ...
              >
                ...
                <feBlend
                  mode="normal"
                  in2="BackgroundImageFix"
                  result="effect1_dropShadow_7_166"
                />
                <feBlend
                  mode="normal"
                  in="SourceGraphic"
                  in2="effect1_dropShadow_7_166"
                  result="shape"
                />
              </filter>
              <linearGradient
                id="paint0_linear_7_166"
                x1="-16.5764"
                y1="-62.2784"
                x2="-144.832"
                y2="-16.7583"
            ...
            <defs>
              ...
              >
                ...
                <feBlend
                  mode="normal"
                  in2="BackgroundImageFix"
                  result="effect1_dropShadow_7_163"
                />
                <feBlend
                  mode="normal"
                  in="SourceGraphic"
                  in2="effect1_dropShadow_7_163"
                  result="shape"
                />
              </filter>
              <linearGradient
                id="paint0_linear_7_163"
                x1="-16.5764"
                y1="-62.2784"
                x2="-144.832"
                y2="-16.7583"
        ...
        <span>
          <svg
            ...
            xmlns="http://www.w3.org/2000/svg"
          >
            <rect width="38" height="38" rx="19" fill="url(#paint0_linear_7_173)" />
            <defs>
              <linearGradient
      ...
      />
      <div className="flex justify-center mt-[25px] lg:mt-[21px] mb-4 lg:mb-5 text-[#565656] text-[14px] font-[poppins]">
